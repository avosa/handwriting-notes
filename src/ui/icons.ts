...
export const icons: Record<string, string> = {
  ...
  tag: '<path d="M20.6 13.4l-7.2 7.2a2 2 0 0 1-2.8 0L2 12V3a1 1 0 0 1 1-1h9l8.6 8.6a2 2 0 0 1 0 2.8z"/><circle cx="7.5" cy="7.5" r="1.2"/>',
  ...
  comment: '<path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-4-1L3 20l1-4.5a8.5 8.5 0 1 1 17-4z"/>',
  ...
  lockOpen: '<rect x="4" y="10" width="16" height="11" rx="2.5"/><path d="M8 10V7a4 4 0 0 1 7.5-1.9"/>',
  ...
  calendar:
    '<rect x="3" y="5" width="18" height="16" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="8" y1="3" x2="8" y2="6"/><line x1="16" y1="3" x2="16" y2="6"/>',
  lasso:
    '<path d="M3 11c0-3.9 4-7 9-7s9 3.1 9 7c0 3.4-3 6.2-7 6.8" stroke-dasharray="2 2"/><path d="M6 16.5a1.6 1.6 0 1 0 0 3.2c1.3 0 2.4-.8 2.4-2"/>',
