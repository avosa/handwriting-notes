  ...
  const shapes: DiagramScene['shapes'] = [
    {
      type: 'label',
      at: { x: 4, y: 8 },
      text: 'Four Categorical Propositions:',
      color: C.ink,
      size: 4,
      anchor: 'start',
    },
...
function buildPages(): Page[] {
  return [
    page(0, [
      ...
      text(
        'body',
        'A set is simply a collection of objects. The objects inside a set are called members or elements. We use curly braces to list the members of a set.',
        { align: 'justify' },
      ),
      text(
        'body',
        'For example, if I define A = {1, 2, 3, 4, 5}, then A is a set containing five numbers. We say 3 is a member of A and write 3 ∈ A. If something is not in the set, like 7, we write 7 ∉ A.',
        { align: 'justify' },
      ),
      text('heading', 'More examples of sets:'),
      text(
        'body',
        'The set of all states in the US. The set of all students in this class. The set of all prime numbers. Sets can contain anything, not just numbers.',
        { align: 'justify' },
      ),
      ...
      text(
        'body',
        'Set A is a subset of set B if every single member of A is also a member of B. We write A ⊆ B. For example, {1, 2, 3} ⊆ {1, 2, 3, 4, 5} because every element in the first set is also in the second.',
        { align: 'justify' },
      ),
      text(
        'body',
        'Two important facts: every set is a subset of itself, and the empty set {} is a subset of every set.',
        { align: 'justify' },
      ),
    ]),
    page(1, [
      ...
      text(
        'body',
        'A Venn diagram is a visual tool for representing sets. We draw circles (or ovals) inside a rectangle. The rectangle represents the universal set, which is everything under consideration. Each circle represents a particular set.',
        { align: 'justify' },
      ),
      text('heading', 'Three types of relationships:'),
      text(
        'body',
        '1. Subset: If all members of A are also in B, we draw circle A entirely inside circle B. Example: All dogs are mammals, so the Dogs circle goes inside the Mammals circle.',
        { align: 'justify' },
      ),
      diagram(
        {
      ...
      text(
        'body',
        '2. Overlapping: If some members are shared but not all, the circles partially overlap. The overlapping region contains members that belong to both sets.',
        { align: 'justify' },
      ),
    ]),
    page(2, [
      ...
      text(
        'body',
        'When two sets share some members but not all, we call them overlapping sets. Think of Athletes and Honor Students at a school. Some students are both athletes and honor students, so the circles overlap.',
        { align: 'justify' },
      ),
      diagram(
        {
      ...
      text(
        'body',
        'When two sets share NO members at all, we call them disjoint sets. The circles do not touch. Example: Cats and Dogs. No animal is both a cat and a dog, so the circles are completely separate.',
        { align: 'justify' },
      ),
      diagram(
        {
    ...
    page(3, [
      ...
      text(
        'body',
        'The intersection of A and B is the set of all elements that are in BOTH A and B. On a Venn diagram, it is the overlapping region where both circles meet.',
        { align: 'justify' },
      ),
      text(
        'body',
        'Example: If A = {1, 2, 3, 4} and B = {3, 4, 5, 6}, then A ∩ B = {3, 4}. Only 3 and 4 appear in both sets.',
        { align: 'justify' },
      ),
      text('heading', 'Union (A ∪ B)'),
      text(
        'body',
        'The union of A and B is the set of all elements that are in A OR B or both. On a Venn diagram, it is everything covered by either circle.',
        { align: 'justify' },
      ),
      text(
        'body',
        'Example: If A = {1, 2, 3, 4} and B = {3, 4, 5, 6}, then A ∪ B = {1, 2, 3, 4, 5, 6}. We combine everything from both sets, but we do not repeat elements.',
        { align: 'justify' },
      ),
    ...
    page(4, [
      ...
      text(
        'body',
        'There are four types of categorical propositions that describe how two sets relate to each other. Each one has a specific Venn diagram representation:',
        { align: 'justify' },
      ),
      text(
        'body',
        '1. "All A are B" means A is a subset of B. Every member of A is also in B. Draw circle A entirely inside circle B.',
        { align: 'justify' },
      ),
      text(
        'body',
        '2. "No A are B" means A and B are disjoint. They share no members. Draw two separate circles that do not touch.',
        { align: 'justify' },
      ),
      text(
        'body',
        '3. "Some A are B" means A and B overlap. At least one member is in both sets. Draw two circles that partially overlap.',
        { align: 'justify' },
      ),
      text(
        'body',
        '4. "Some A are not B" means part of A is outside B. At least one member of A is not in B. Draw A so that some portion extends beyond B.',
        { align: 'justify' },
      ),
    ...
    page(5, [
      ...
      text(
        'body',
        'When we have three sets, we draw three overlapping circles. This creates 8 distinct regions. Each region represents a unique combination of being inside or outside each of the three sets.',
        { align: 'justify' },
      ),
      text(
        'body',
        'For example, the center region where all three circles overlap represents elements that belong to A AND B AND C simultaneously. A region inside A and B but outside C represents elements in both A and B but not in C.',
        { align: 'justify' },
      ),
      diagram(
        {
      ...
      text(
        'body',
        'The 8 regions are: only A, only B, only C, A and B only, A and C only, B and C only, all three, and none of them (outside all circles but inside the rectangle).',
        { align: 'justify' },
      ),
    ]),
    page(6, [
